<template>
  <div class="contents bottom-sticky" ref="contents">
    ...
    <div class="slider-prd">
      <img src="../../../assets/images/program/class106-slide1.jpg" alt="T Factory POP-UP Exhibition">
    </div>
    <!-- //slide -->
    <!-- details -->
    <div class="details sticky">
      <div class="details-header" style="padding: 32px 12px 40px 20px;">
        <kakao-share
         title="LCK 스프링 결승전 응원전"
          description="'Piglet' 채광진님과 함께하는 LCK 스프링 결승전 응원 Event가 진행됩니다."
        ></kakao-share>
      ...
      <div class="details-inner">
        <h2 class="main-title" style="line-height: 40px;">PIGLET<br>채광진 코치 소개
        </h2>
