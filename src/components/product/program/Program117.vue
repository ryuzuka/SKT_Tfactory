<template>
  <div class="contents bottom-sticky" ref="contents">
    ...
    <div class="slider-prd">
      <img ref="shareImage" src="../../../assets/images/program/class117-slide1.jpg" alt="T Factory x FLO 덕콘 | 2022.5 브랜뉴차일드 / 미스몰리">
    </div>
    <!-- //slide -->
    <!-- details -->
    <div class="details sticky">
      <div class="details-header" style="padding: 31px 12px 40px 20px;">
        <kakao-share
          title="5월의 덕콘"
          description="인기 뮤지션과 대학생 뮤지션이 꾸미는 스페셜 무대 - 2022.5 브랜뉴차일드 / 미스몰리"
        ></kakao-share>
        ...
        <p class="desc2">
          5월의 덕콘 무대는 인기 뮤지션과 대학생 뮤지션이 함께 합니다. 핫한 뮤지션과 우리 학교 뮤지션이 꾸며줄 THECON의 무대와 함께 하세요.<br>
          T Factory에 방문하고 대학생 뮤지션들의 소중한 관객이 되어 축제를 즐겨주세요.
        </p>
      </div>
      <div class="line">
        <span style="margin: 1px 29px;">2022. 05. 21 PM 2:00 <em style="margin-left:10px;">BRANDNEWCHILD</em></span>
      ...
      <div class="details-header" style="padding: 40px 20px;">
        ...
        <h2 class="main-title" style="margin-top:4px;">브랜드뉴차일드</h2>
        <div class="thumbnail"><img src="../../../assets/images/program/class117-conts1.jpg" alt=""></div>
        <p style="margin-top: 8px;">
          ‘Brand New Child’ 팀은 청주 지역을 기점으로 전국 각지에서 스트릿댄스를 중점으로 활발히 활동 하고 있는 팀이다. 연령은 중학생부터 고등학생까지 이루어진 팀이고, 매년 배틀 및 퍼포먼스 대회에서 우수한 성적을 거두고 있다.
        </p>
        <p style="margin-top: 22px;">
          최근 대한민국 청소년들의 마음을 뜨겁게 달구었던 엠넷 &lt;스트릿댄스 걸스 파이터&gt;에 출연하여 다인원의 위엄을 보이며 파이널 4위라는 성적을 거두어 활발히 활동하고 있다.
        </p>
        <p style="margin-top: 22px;">
          ‘Brand New Child’ 팀은 춤을 사랑하는 이들이 모인 만큼 춤과 팀원 간의 애정이 가득한 팀이다.
        </p>
      </div>
      <div class="details-inner">
        ...
        <dl>
          <dd>
            ...
            <span class="desc">5월 21일 (토) 오후 2시</span>
          </dd>
           <dd>
            <span class="sub_title" style="width: 52px;">신청기간</span>
            <span class="desc">4월 29일 (금) ~ 5월 15일 (일)</span>
          </dd>
           <dd>
      ...
      <div class="line">
        <span style="margin: 1px 56px;">2022. 05. 21 PM 3:00 <em style="margin-left:10px;">MISMOLLY</em></span>
        <img src="../../../assets/images/program/line-bg.png" alt="THECON line-bg">
      </div>
      <div class="details-header" style="padding: 40px 20px;">
        <em class="main-subtitle">아티스트 소개</em>
        <h2 class="main-title" style="margin-top:4px;">미스몰리</h2>
        <div class="thumbnail"><img src="../../../assets/images/program/class117-conts2.jpg" alt=""></div>
        <p style="margin-top: 8px;">
          ‘미스몰리’는 광주, 정읍 지역의 아이엠스튜디오 소속 전공 입시반 고등학생들로 이루어져 있는 올장르 청소년 퍼포먼스팀이다.<br>
          스트릿댄스를 기반으로 하여 매년 특별한 컨셉의 다양한 퍼포먼스를 선보이는 팀이다.
        </p>
      </div>
      <div class="details-inner">
        <h2 class="main-title">일정</h2>
        <dl>
          <dd>
            <span class="sub_title" style="width: 52px;">공연일</span>
            <span class="desc">5월 21일 (토) 오후 3시</span>
          </dd>
           <dd>
            <span class="sub_title" style="width: 52px;">신청기간</span>
            <span class="desc">4월 29일 (금) ~ 5월 15일 (일)</span>
      ...
      <div class="details-inner" style="padding: 32px 20px 12px;">
        <em class="main-subtitle">5월의 덕콘</em>
