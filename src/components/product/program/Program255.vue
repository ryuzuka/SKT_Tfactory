<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class255-slide1.jpg" alt="수능 이벤트 | 얘드라 책 덮고 클래스 챙겨!">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <h2 class="main-title" style="margin-top:4px;">자이언트 얀 가방 클래스</h2>
        ...
        <p class="desc2" style="margin-top: 8px;">
					핑거니팅으로 굵은 실을 이용해 어깨에 살짝 걸치는<br />호보백을 만드는 클래스입니다. 초보자분들도 금방<br />만드는 법을 익히고 짧은 시간 안에 가방을 완성할 수<br />있는 클래스입니다.
				</p>
