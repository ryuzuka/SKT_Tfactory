<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class268-slide1.jpg" alt="T Factory x FLO 덕콘 | 2022.12 윤석철트리오">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <p class="desc2" style="margin-top:8px;">
			...
			<div class="line">
				<span style="margin: 0px 15px;">2022. 12. 31 PM 7:00<em style="margin-left:12px;">YUNSEOKCHEOL TRIO</em></span>
			...
			<div class="details-header" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">윤석철트리오</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class268-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					'윤석철트리오'는 '재즈와 팝, 일렉트로닉, 발라드까지<br />모든 장르를 넘나드는 한국 재즈계의 대표주자이다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">12월 31일 (토) 오후 7시</span>
					</dd>
					<dd>
