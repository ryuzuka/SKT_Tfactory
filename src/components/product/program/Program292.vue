          ...
          <li style="margin-bottom: 32px;">
            ...
            <dl style="margin-bottom: 24px;">
              <dd>
                ...
                <span class="desc" style="margin-left: 12px;">5/12(금) 오후 7시</span>
              </dd>
              <dd>
                <span class="sub_title">응모일정</span>
                <span class="desc" style="margin-left: 28px;">4/29(토) ~ 5/5(금)</span>
              </dd>
              <dd>
                <span class="sub_title">당첨자 발표</span>
                <span class="desc" style="margin-left: 12px;">5/6(토) 발표</span>
              </dd>
            </dl>
            <div class="btn-wrap" style="margin-top: 12px">
              <a class="btn-line big disabled" disabled to="/experience/program292?classId=252">
                클래스 예약하기
              </a>
            </div>
          </li>
