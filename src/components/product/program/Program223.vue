<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class223-slide1.jpg" alt="T Factory x FLO 덕콘 | 2022.9 PATZ">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <h2 class="main-title" style="margin-top:4px;">9월의 덕콘</h2>
        <p class="desc2">
          T Factory와 FLO가 함께 만드는 팬 초청 소규모 콘서트!<br>
			...
			<div class="line">
				<span style="margin: 0px 77px;">2022. 09. 16 PM 7:00<em style="margin-left:12px;">PATZ</em></span>
			...
			<div class="details-header" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">PATZ</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class223-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					밴드 PATZ는 신스팝 밴드‘Parts of the city’라는 아이덴티티를 기반으로 도시에서 느낀 감정을 담은 도회적인 무드와 가사를 추구하는 밴드이다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					PATZ는 서병수(보컬), 김정훈(드럼), 김유민(베이스), 박재희(기타) 4인으로 이루어져 있다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">9월 16일 (금) 오후 7시</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px;">신청기간</span>
						<span class="desc">9월 1일 (목) ~ 9월 11일 (일)</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px;">당첨자발표</span>
						<span class="desc">9월 12일 (월) 오후 3시</span>
					</dd>
					<dd>
      ...
      <div class="details-bottom details-inner" style="padding: 40px 20px 12px;">
        <em class="main-subtitle">9월 덕콘</em>
          ...
          <li>
	          ...
	          <router-link to="/experience/program223?classId=">
		          <div class="card" Style="margin-left: 19px;">
			          ...
			          <div class="image">
				          <img src="../../../assets/images/program/class222-musician1.png" alt="musician">
			          </div>
		          </div>
	          </router-link>
          </li>
          <li>
	          ...
	          <router-link to="/experience/program224?classId=">
		          <div class="card" Style="margin-left: 19px;">
			          ...
			          <div class="image">
				          <img src="../../../assets/images/program/class222-musician2.png" alt="musician">
			          </div>
		          </div>
	          </router-link>
          </li>
