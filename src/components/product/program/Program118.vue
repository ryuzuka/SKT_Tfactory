<template>
  <div class="contents bottom-sticky" ref="contents">
    ...
    <div class="details sticky">
      ...
      <div class="line">
        <span style="margin: 1px 65px;">2022. 05. 27 PM 7:00<em style="margin-left:11px;">LACUNA</em></span>
      ...
      <div class="details-inner">
        ...
        <dl>
          <dd>
            ...
            <span class="desc">5월 27일 (금) 오후 7시</span>
          </dd>
           <dd>
            <span class="sub_title" style="width: 52px;">신청기간</span>
            <span class="desc">4월 29일 (금) ~ 5월 22일 (일)</span>
          </dd>
           <dd>
