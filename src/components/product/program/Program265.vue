<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class265-slide1.jpg" alt="T Factory x FLO 덕콘 | 2022.12 ADOY">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <p class="desc2" style="margin-top:8px;">
			...
			<div class="line">
				<span style="margin: 0px 75px;">2022. 12. 24 PM 7:00<em style="margin-left:12px;">ADOY</em></span>
			...
			<div class="details-header" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">ADOY</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class265-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					청춘의 정서를 안고 달리는 밴드, ADOY(아도이)
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					아도이는 신스팝을 기반으로 음악성과 대중성을 동시에 갖춘 보기 드문 밴드이다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					아도이의 음악이 연상시키는 건 무척 단순하고 직관적인 것들이다. 여름, 바다, 파도, 서핑, 공원, 달리기, 밤공기,<br />맥주처럼 잠시 떠올리는 것만으로 기분 좋아지는 것들. 거기에 여행, 꿈, 미래, 실수, 외로움 같은 조금 복잡한<br />뒷이야기를 가진 이미지들이 더해진다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					2017년 EP [CATNIP], 2018년 EP [LOVE]는 잘 다듬어진 사운드와 멜로디로 국내외 음악 관계자들과 팬들에게 큰 호응을 얻으며, 공연 섭외 1순위 밴드로 빠르게 자리 잡았다.
					2019년 [VIVID]를 발표한 아도이는 이제 한국을 넘어 태국, 대만, 일본, 홍콩, 필리핀, 싱가포르, 베트남 등 활동 반경을 넓혀 나가며 그들만의 색깔이 확실한 라이브를 선보였다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">12월 24일 (토) 오후 7시</span>
					</dd>
					<dd>
