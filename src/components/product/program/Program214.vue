<template>
	<div class="contents bottom-sticky" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class214-slide1.jpg" alt="With Z Flip 4 & XEXYMIX | 홍둥이">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <p class="desc2">
			...
			<div class="details-inner" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">윤채형&윤원형</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class214-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					윤쌤이라 불리는 윤채형 님은 쌍둥이 동생과 함께 다이어트 댄스 '흥둥이' 콘텐츠를 운영하고 있고 인스타그램 51만 명을 보유하고 있다.<br>
					'누구나 재밌게 운동할 수 있다'라는 모토로 유튜브와 sns를 통해 재밌는 운동 콘텐츠를 선보이며 많은 인기를 얻고 있다.
				</p>
				<p class="desc_20" style="margin-top: 8px;">
					뇽쌤이라 불리는 윤원형 님은 쌍둥이 언니와 함께 다이어트 댄스 '흥둥이' 콘텐츠를 운영하고 있다.<br>
					인스타그램 23만 명을 보유하고 있으며, 임산부 산전산후 운동 콘텐츠도 제작 운영 중이다.<br>
					누구나 쉽게 따라 할 수 있는 영상으로 한 번의 영상으로도 뇽쌤의 매력을 느낄 수 있다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">8월 20일 (토) 오후 8시</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 70px;">응모기간</span>
						<span class="desc">8월 12일 (금) ~ 8월 17일 (수)</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 70px;">당첨자발표</span>
						<span class="desc">8월 18일 (목) *당첨자 한해 개별 연락</span>
					</dd>
					<dd>
