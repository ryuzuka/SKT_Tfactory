<template>
  <div class="contents bottom-sticky" ref="contents">
    ...
    <div class="slider-prd">
      <img src="../../../assets/images/program/class71-slide1.jpg" alt="T Factory X FLO 덕후콘 | 2021.12 최엘비">
    </div>
    <!-- //slide -->
    <!-- details -->
    <div class="details sticky">
      <div class="details-header">
        <kakao-share
          title="12월의 덕콘 | 최엘비"
          description="찐덕들만 초청하여 진행하는 덕콘. 이번 기출영역은 '최엘비'입니다."
        ></kakao-share>

        <em class="flag-solid7">CONCERT</em>
        <h2 class="details-tit">
          12월의 덕콘<i class="pipe"></i>최엘비
        </h2>
        <div class="tags">
      ...
      <div class="details-inner">
        ...
        <h3 class="subtit" style="margin-top: 40px;">최엘비 소개</h3>
        <div class="thumb"><img src="../../../assets/images/program/class71-conts1.jpg" alt=""></div>
        <p>최엘비는 힙합 레이블 데자부그룹 소속래퍼입니다. 누구보다 솔직하고 단단한 스토리텔링으로 앨범 단위의 활동에서 더욱 빛을 발하고 있는 아티스트입니다. 정규 1집 [오리엔테이션]은 한국대중음악상 최우수 랩&힙합 음반 수상후보에 노미네이트 되었습니다. 데자부그룹에 합류하고 발표한 정규3집 [독립음악]은 프로듀싱과 구성이 탄탄함과 동시에 많은 이들의 공감을 자아내는 솔직한 가사로 “올해의 음반”후보로 거론될 정도로 많은 관심을 받고 있습니다.</p>
        <h3 class="subtit">{{ $t('prd.schedule-place')}}</h3>
        <ul class="texts-list">
          <li>일정 : 12월 11일(토) 오후 4시</li>
