<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class248-slide1.jpg" alt="수험생을 위한 스페셜 덕콘 | 2022.11 옥상달빛">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <p class="desc2" style="word-break:keep-all;">
          그동안 열심히 달려온 수험생들을 위해 T Factory에서 많은 아티스트들과 함께 &lt;스페셜 덕콘&gt;을 준비했어요! 만나고 싶은 최애 아티스트가 라인업에 있다면 지금 바로 참가 신청해보세요!<br>
			...
			<div class="line">
				<span style="margin: 0px 67px;">2022. 11. 25 PM 7:00<em style="margin-left:12px;">옥상달빛</em></span>
			...
			<div class="details-header" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">옥상달빛</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class248-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					두 동갑내기 여성 김윤주와 박세진으로 이루어진 듀오<br />옥상달빛.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					이들의 매력은 분명하다. ‘일상의 언어’로 노래하는 ‘일상의 이야기’들, 특유의 담백하면서도 위트 넘치는 노랫말로 전하는 삶에 대한 진솔한 메시지가 그것이다.<br />옥상달빛의 음악엔 인생의 희비가 고스란히 녹아있다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					인생의 모순을 있는 그대로 인정하면서도 그 속에서 긍정의 메시지를 끄집어내 때로는 청량함과 경쾌함으로, 때로는 정제된 차분함으로 풀어내는 이들의 음악은 ‘인생은 늘 행복과 슬픔이, 환희와 절망이 교차하지만 그래도, 그래서, 여전히 아름다운 것’이라 이야기한다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					하드코어 한 인생사에 지친 우리들의 어깨를 조용히 다독거리는 작은 치유, 옥상달빛 음악의 진정한 힘이다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">11월 25일 (금) 오후 7시</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px;">신청기간</span>
						<span class="desc">11월 17일 (목) ~ 11월 21일 (월)</span>
					</dd>
					<dd>
