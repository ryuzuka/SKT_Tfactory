<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class290-slide1.jpg" alt="사진 작가가 직접 알려주는 Photo Class | 한기재 작가">
		</div>
    <!-- //slide -->
    <!-- details -->
    <div class="details sticky">
      <div class="details-header" style="padding: 28px 12px 40px 20px;">
        ...
        <h2 class="main-title" style="margin-top:9px; font-size: 24px;">사진 작가가 직접 알려주는<br />Photo Class | 한기재 작가</h2>
          ...
          <li>
            ...
            <dl>
              ...
              <dd>
                ...
                <span class="desc" style="margin-left: 28px;">3/14(화) ~ 3/20(월)</span>
              </dd>
              <dd>
