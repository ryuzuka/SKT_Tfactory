<template>
  <div class="contents bottom-sticky" ref="contents">
    ...
    <div class="slider-prd">
      <img src="../../../assets/images/program/class73-slide1.jpg" alt="T Factory X FLO 덕후콘 | 2021.12 디핵">
    </div>
    <!-- //slide -->
    <!-- details -->
    <div class="details sticky">
      <div class="details-header">
        <kakao-share
          title="12월의 덕콘 | 디핵"
          description="찐덕들만 초청하여 진행하는 덕콘. 이번 기출영역은 '디핵'입니다."
        ></kakao-share>

        <em class="flag-solid7">CONCERT</em>
        <h2 class="details-tit">
          12월의 덕콘<i class="pipe"></i>디핵
        </h2>
        <div class="tags">
      ...
      <div class="details-inner">
        ...
        <h3 class="subtit" style="margin-top: 40px;">디핵 소개</h3>
        <div class="thumb"><img src="../../../assets/images/program/class73-conts1.jpg" alt=""></div>
        <p>
          디핵(D-Hack)은 2015년 'D Got Pa$t' Mixtape, 2016년 EP 'D의 환상'으로 정식 데뷔를 하였으며, 정규 앨범 1장, EP 6장, 싱글 10장 등 꾸준한 음악 활동과 개성있는 영상으로 단단한 커리어를 쌓아온 뮤지션이다.
          올해 초 ‘OHAYO MY NIGHT’가 TIKTOK에서 큰 인기를 얻었고 주요 음원 플랫폼 음원 차트의 상위권을 기록하며 2021년 새로운 역주행의 아이콘으로 등극했다.
        </p>
        <h3 class="subtit">{{ $t('prd.schedule-place')}}</h3>
        <ul class="texts-list">
          <li>일정 : 12월 18일(토) 오후 5시</li>
