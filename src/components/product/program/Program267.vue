<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class267-slide1.jpg" alt="T Factory x FLO 덕콘 | 2022.12 크리스탈티">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <p class="desc2" style="margin-top:8px;">
			...
			<div class="line">
				<span style="margin: 0px 45px;">2022. 12. 31 PM 3:00<em style="margin-left:12px;">CRYSTAL TEA</em></span>
			...
			<div class="details-header" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">크리스탈티</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class267-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					크리스탈 티는 밴드 사운드를 지향하는 서울 기반의 싱어송라이터다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					성씨와 이름을 영어로 옮긴 활동명은 고체(crystal)와 액체(tea)라는 실재하지 않는 상성의 조합을 뜻한다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					하지만, 그 이질감이 가져다주는 불편함 속에서 반짝이면서도 따뜻한 존재가 되고픈 마음을 두루두루 담아냈다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
			...
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">12월 31일 (토) 오후 3시</span>
					</dd>
					<dd>
					...
					<dd>
						...
						<span class="desc">T Factory 2층, 1 Stage</span>
					</dd>
				</dl>
			</div>
