	...
	<div class="contents bottom-sticky" ref="contents">
        ...
        <p class="desc2">
			...
			<div class="details-inner" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">오윤하</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class216-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					'국내 최초 발레핏 창시 및 개발자인 오윤하 님은 발레핏 코리아 대표이다. <br/>
					2019년 책 '우아하게 발레핏' 출간했고 그녀의 발레 사랑은 무한하다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">9월 3일 (토) 오전 9시30분</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 70px;">응모기간</span>
						<span class="desc">8월 19일 (금) ~ 8월 31일 (수)</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 70px;">당첨자발표</span>
						<span class="desc">9월 1일 (목) *당첨자 한해 개별 연락</span>
					</dd>
					<dd>
