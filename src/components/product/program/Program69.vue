<template>
  <div class="contents bottom-sticky" ref="contents">
    ...
    <div class="slider-prd">
      <img src="../../../assets/images/program/class69-slide1.jpg" alt="T Factory X FLO 덕후콘 | 2021.12 불고기디스코">
    </div>
    <!-- //slide -->
    <!-- details -->
    <div class="details sticky">
      <div class="details-header">
        <kakao-share
          title="12월의 덕콘 | 불고기디스코"
          description="찐덕들만 초청하여 진행하는 덕콘. 이번 기출영역은 '불고기디스코'입니다."
        ></kakao-share>

        <em class="flag-solid7">CONCERT</em>
        <h2 class="details-tit">
          12월의 덕콘<i class="pipe"></i>불고기디스코
        </h2>
        <div class="tags">
      ...
      <div class="details-inner">
        ...
        <h3 class="subtit" style="margin-top: 40px;">불고기디스코 소개</h3>
        <div class="thumb"><img src="../../../assets/images/program/class69-conts1.jpg" alt=""></div>
        <p>불고기디스코는독특한 밴드다. 이현송, 김형균, 김동현 세 연주자와 사운드 엔지니어 허정욱이 합을 맞췄다. 플레이어 모두 홍대에서 잔뼈가 굵은 이들로, 탄탄한 연주력을 보여준다. 엔지니어 허정욱은 밴드 멤버 일원으로서 이들 음악에 통일감을 부여한다.</p>
        <p style="margin-top:22px">2019년 9월 첫 싱글 &#60;가을이 왔어&#62;로 데뷔한 밴드는 누구보다 정열적으로 활동하고 있다. 불고기디스코는 지금까지 9장의 싱글과 각 한장의 정규 앨범과 EP를 내면서, 밴드의  창작성과 에너지를 보여주고 있다.</p>
        <p style="margin-top:22px">불고기 디스코 음악의 장르는 한가지로 규정할 수 없다. 록 본연의 거친 힘을 잃지 않으면서 디스코와 레게 리듬 등 여러 요소를 모던한 감각으로 엮는다. 이들의 음악 장르를 굳이 한 단어로 표현해야 한다면, ‘불고기디스코’라고 불러야 할 것이다.</p>
        <h3 class="subtit">{{ $t('prd.schedule-place')}}</h3>
        <ul class="texts-list">
          <li>일정 : 12월 10일(금) 오후 6시 30분</li>
