<template>
	<div class="contents bottom-sticky" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class215-slide1.jpg" alt="With Z Flip 4 & XEXYMIX | 신지수">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <p class="desc2">
					유명 강사진들과 다양한 종목이 준비되어 있는 Wonder Workout Class에 초대합니다.<br>
					운동 클래스 신청 후 재밌는 운동을 현장에서 직접 배워보세요!
        </p>
			</div>
			<div class="details-inner" style="padding: 40px 20px;">
				<em class="main-subtitle">강사 소개</em>
				<h2 class="main-title" style="margin-top:4px;">신지수</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class215-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					걸그룹 '타히티' 출신인 신지수 님은 현재 수 필라테스 스튜디오 운영을 운영하고 있다. <br/>
					나우 비긴 라이브 클래스 진행, 현대 백화점 문화센터 수업(압구정 , 신촌 , 미아 , 삼성 일산 등) 등 다양한 수업 경력이 있다. <br/>
					바프 챌린지, 다양한 방송 출연 그리고 국민체육진흥공단 홍보대사로 활동하며, 다재다능한 능력을 지녔다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">8월 27일 (토) 오전 9시 30분</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 70px; color: #ff404e;">인원</span>
						<span class="desc" style="color: #ff404e;">8쌍 (전체 16명) *남녀 커플 아니어도 신청<br/>가능하며, 친구, 연인, 가족 모두 참여 가능<br/>합니다.</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 70px;">응모기간</span>
						<span class="desc">8월 12일 (금) ~ 8월 24일 (수)</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 70px;">당첨자발표</span>
						<span class="desc">8월 25일 (목) *당첨자 한해 개별 연락</span>
					</dd>
					<dd>
