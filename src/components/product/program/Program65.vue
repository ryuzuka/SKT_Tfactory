<template>
  <div class="contents bottom-sticky" ref="contents">
    ...
    <div class="slider-prd">
      <img src="../../../assets/images/program/class65-slide1.jpg" alt="T Factory X FLO 덕후콘 | 2021.11 김제형">
    </div>
    <!-- //slide -->
    <!-- details -->
    <div class="details sticky">
      ...
      <div class="details-inner">
        ...
        <h3 class="subtit" style="margin-top: 40px;">김오키새턴발라드 소개</h3>
        <div class="thumb"><img src="../../../assets/images/program/class65-conts2.jpg" alt=""></div>
        <p>김오키새턴발라드는 색소폰 김오키, 피아노 진수영, 베이스 정수민으로 이루어져 있으며, 그루브 넘치는 발라드를 연주한다.</p>
        <h3 class="subtit">{{ $t('prd.schedule-place')}}</h3>
        <ul class="texts-list">
          <li>일정 : 12월 4일(토) 오후 4시~5시</li>
