<template>
	<div class="contents bottom-sticky" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class213-slide1.jpg" alt="With Z Flip 4 & XEXYMIX | 고유라">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <p class="desc2">
			...
			<div class="details-inner" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">고유라</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class217-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					동기부여 연설가인 고유라 님은 유챌 창시 및 개발자이다. <br/>
					스스로의 회복 에너지를 되찾고 몸과 마음에 자유를 선물하는 호흡 요가와 얼굴 호흡 요가를 진행하고 있다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">9월 10일 (토) 오전 9시30분</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 70px;">응모기간</span>
						<span class="desc">8월 26일 (금) ~ 9월 7일 (수)</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 70px;">당첨자발표</span>
						<span class="desc">9월 8일 (목) *당첨자 한해 개별 연락</span>
					</dd>
					<dd>
