<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class236-slide1.jpg" alt="롤드컵 8강 응원전">
		</div>
		<!-- //slide -->
		<!-- details -->
		<div class="details sticky">
          ...
          description="롤드컵 8강 응원전"
        ></kakao-share>

        <em class="main-subtitle">T Factory X T1</em>
        <h2 class="main-title" style="margin-top:4px; margin-bottom:16px; letter-spacing: -1px;">롤드컵 8강 응원전</h2>
				<p class="desc2" style="margin-top:12px;">
					T Factory에서 T1의 4강 진출을 기원하며<br>
			...
			<div class="details-inner">
				...
				<dl>
					...
					<dd>
						...
						<span class="desc">10월 20일(목) 오후3시<br>*당첨자 한해 개별 안내</span>
					</dd>
				</dl>
			</div>
