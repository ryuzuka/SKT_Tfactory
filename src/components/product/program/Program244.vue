<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="details sticky">
          ...
          description="롤드컵 파이널 응원전"
        ></kakao-share>

        <em class="main-subtitle">T Factory X T1</em>
        <h2 class="main-title" style="margin-top:4px; margin-bottom:16px; letter-spacing: -1px;">롤드컵 파이널 응원전</h2>
				<p class="desc2" style="margin-top:12px;">
					T1 파이널 진출 확정!
				</p>
				<p class="desc2" style="margin-top:12px;">
					T Factory에서 T1을 함께 응원하세요!<br>
			...
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">11월 6일 (일) 오전 6시</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px;">응모기간</span>
						<span class="desc">10월 31일 (월) ~ 11월 1일 (화)</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px;">당첨자발표</span>
						<span class="desc">11월 2일 (수) 오후 3시<br />*당첨자 한해 개별 안내</span>
					</dd>
				</dl>
			</div>
			<div class="details-inner notification">
				...
				<ul>
					<li>※본 프로그램은 T Factory 홍대점을 방문하여 스마트폰으로 본인<br>확인한 경우에만 참여 가능합니다. (본인확인 가능 연령: 만 14세<br>이상)</li>
