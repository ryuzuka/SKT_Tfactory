<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class264-slide1.jpg" alt="T Factory x FLO 덕콘 | 2022.12 LUCY">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <p class="desc2" style="margin-top:8px;">
			...
			<div class="line">
				<span style="margin: 0px 76px;">2022. 12. 23 PM 7:00<em style="margin-left:12px;">LUCY</em></span>
			...
			<div class="details-header" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">LUCY</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class264-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					음악을 통해 새로운 공간으로 인도하는 Guide이자, 리스너와 함께 여행하는 Traveler라는 음악적 세계관을 통해 LUCY는 많은 이들과 음악으로 빚어진 새로운 세계로 여행을 하고 있다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					지난 2020년 5월 8일, 첫 싱글 앨범 &lt;DEAR.&gt;를 시작으로 &lt;PANORAMA&gt;, &lt;선잠&gt;, &lt;INSIDE&gt;, &lt;Gatcha!&gt;, &lt;동문서답&gt;, &lt;BLUE&gt;까지 LUCY 멤버들이 직접 프로듀싱과 작사/작곡을 진행하며 다양한 장르와 스타일의 곡을 시도, 음악적 스펙트럼을 자체적으로 확장하고 있다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					2022년 3월 31일, 4월 7일 밴드 데이브레이크와 콜라보레이션 앨범을 발매하며 밴드 선, 후배 간의 우정을 과시하였다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					최근 발매한 정규 1집 &lt;Childhood&gt; 내 무려 15곡의 다양한 곡들을 선보였으며, 동명의 콘서트를 진행, 앵콜 콘서트까지 모두 1분 안에 매진시켜 팬덤과 실력을 입증하였다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">12월 23일 (금) 오후 7시</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px; margin-bottom: 6px;">신청기간</span>
						<span class="desc">12월 2일 (금) ~ 12월 18일 (일)</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px; margin-bottom: 6px;">당첨자발표</span>
						<span class="desc">12월 19일 (월) 오후 3시</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px; margin-bottom: 6px;">장소</span>
