<template>
	<div class="contents bottom-sticky" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class201-slide1.jpg" alt="T Factory x FLO 덕콘 | 2022.6 요조">
		</div>
		<!-- //slide -->
		<!-- details -->
		<div class="details sticky">
			<div class="details-header" style="padding: 31px 12px 40px 20px;">
				<kakao-share
					title="6월의 덕콘"
					description="인기 뮤지션과 대학생 뮤지션이 꾸미는 스페셜 무대 - 2022.6 요조"
				></kakao-share>
			...
			<div class="line">
				<span style="margin: 1px 70px;">2022. 06. 24 PM 7:00<em style="margin-left:11px;">YOZOH</em></span>
			...
			<div class="details-header" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">요조</h2>
				<div class="thumbnail"><img src="../../../assets/images/program/class201-conts1.jpg" alt=""></div>
				<p style="margin-top: 8px;">
					요조는 싱어송라이터로 2004년 허밍어반스테레오,<br>015B 등의 객원 보컬로 활동하다 2007년 소규모아카시아밴드와 함께 &lt;My Name is YOZOH with 소규모아카시아밴드&gt;를 발매하며 본격 데뷔했다.
				</p>
				<p style="margin-top: 22px;">
					2022년 현재, 그녀를 소개하는 수많은 수식어가 있다.<br>독서가. '책방무사'의 책방주인. 작가. 영화감독. 영화배우. 프로 방송인. 팟캐스트 진행자. 페미니스트. 트잉여. 무엇보다 뮤지션.
				</p>
				<p style="margin-top: 22px;">
			...
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">6월 24일 (금) 오후 7시</span>
					</dd>
					<dd>
