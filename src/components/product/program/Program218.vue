<template>
	<div class="contents bottom-sticky" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class213-slide1.jpg" alt="With Z Flip 4 & XEXYMIX | 홍둥이">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <p class="desc2">
			...
			<div class="details-inner" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">박소리</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class218-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					걸그룹 '베이비복스' 출신인 박소리 님은 밀양 요가 대회에서 우승, 2021 선사 요가 시퀀스 챔피언십 1위를 수상하면서 다시 한번 이름을 알리게 되었다. <br/>
					그 후 지도자 과정을 이수하고 현재 울룰루 요가 강사로 활동하고 있다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">9월 17일 (토) 오전 9시30분</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 70px;">응모기간</span>
						<span class="desc">9월 2일 (금) ~ 9월 14일 (수)</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 70px;">당첨자발표</span>
						<span class="desc">9월 15일 (목) *당첨자 한해 개별 연락</span>
					</dd>
					<dd>
