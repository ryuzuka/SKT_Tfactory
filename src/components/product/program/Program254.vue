<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class254-slide1.jpg" alt="수능 이벤트 | 얘드라 책 덮고 클래스 챙겨!">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <h2 class="main-title" style="margin-top:4px;">펀칭니들 클래스</h2>
        ...
        <p class="desc2" style="margin-top: 8px;">
          귀여운 도안이 그려진 천 위를 전용 니들로 찔러서 수를 놓는 펀칭니들 클래스입니다.
        </p>
        <p class="desc2" style="margin-top: 12px;">
          방법이 간단해서 초보자분들도 금방 배울 수 있는<br />클래스입니다. 반복하다 보면 채워지는 작업 스타일에서 힐링과 재미를 느낄 수 있습니다.
        </p>
