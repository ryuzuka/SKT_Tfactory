<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class300-slide1.jpg" alt="나만의 커스텀 휴대폰 만들기">
		</div>
    <!-- //slide -->
    <!-- details -->
    <div class="details sticky">
      <div class="details-header" style="padding: 28px 12px 40px 20px;">
        <kakao-share
         title="나만의 커스텀 휴대폰 만들기"
          description="나만의 커스텀 휴대폰 만들기"
        ></kakao-share>

        <em class="main-subtitle">[Crew Class]</em>
        <h2 class="main-title" style="margin-top:9px; font-size: 24px;">나만의 커스텀 휴대폰 만들기</h2>
        <p class="desc2" style="margin-top:24px;">
          휴대폰 테마부터 폰케이스, 그립톡, 스트랩까지 <br />세상에 하나뿐인 나만의 휴대폰을 만들어보세요!
        </p>
      </div>
      <div class="details-inner" style="padding: 30px 20px 40px;">
        ...
        <ul class="festival_events">
          ...
          <li>
            ...
            <span>개인 휴대폰, 투명 케이스.<br />투명 케이스는 T Factory 보유 기종에 한해 무료 제공됩니다.</span>
          </li>
          <li>
            <p class="sub_event" style="color: #000; font-weight: bold; margin-bottom: 10px; margin-top: 20px;">추천 대상</p>
            <span>나만의 특별한 휴대폰을 만들고 싶으신 분<br />
                  가족, 연인, 친구와 소중한 추억을 남기고 싶으신 분<br />
                  최근 유행에 따라가고 싶으신 분</span>
          </li>
          <li>
