<template>
	<div class="contents bottom-sticky" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class209-slide1.jpg" alt="T Factory x FLO 덕콘 | 2022.8 실리카겔">
		</div>
		<!-- //slide -->
		<!-- details -->
        ...
        <h2 class="main-title" style="margin-top:4px;">8월의 덕콘</h2>
        <p class="desc2">
          T Factory와 FLO가 함께 만드는 팬 초청 소규모 콘서트!<br>
					지친 일상 속 힐링을 선사하기 위해 매월 다양한 아티스트의 무료 콘서트를 진행합니다.<br>
					아티스트가 낸 덕력고사를 풀고 콘서트 초청의 기회를 잡아보세요.
        </p>
			</div>
			<div class="line">
				<span style="margin: 0px 53px;">2022. 08. 19 PM 7:00<em style="margin-left:12px;">SILICA GEL</em></span>
			...
			<div class="details-header" style="padding: 40px 20px;">
				...
				<h2 class="main-title" style="margin-top:4px;">실리카겔</h2>
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class209-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					‘새롭고 용감한 사운드 (Brave New Sound)’, 밴드 실리카겔 (Silica gel)밴드 ‘실리카겔’은 김한주(건반/보컬), 김춘추(기타/보컬), 김건재(드럼), 최웅희(베이스) 4인으로 이루어진 밴드다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					다채로운 스펙트럼을 바탕으로 구축해낸 고유의 사이키델리아, 폭발적인 에너지의 라이브 퍼포먼스가 응집하여 현재 가장 새롭고, 용감한, 사운드를 만드는 밴드 ‘실리카겔 (Silica gel)’이 되었다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">8월 19일 (금) 오후 7시</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px;">신청기간</span>
						<span class="desc">8월 1일 (월) ~ 8월 14일 (일)</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px;">당첨자발표</span>
						<span class="desc">8월 15일 (월) 오후 3시</span>
					</dd>
					<dd>
      ...
      <div class="details-bottom details-inner" style="padding: 40px 20px 12px;">
        <em class="main-subtitle">8월 덕콘</em>
          ...
          <li>
	          ...
	          <router-link to="/experience/program205?classId=166">
		          <div class="card" Style="margin-left: 19px;">
			          ...
			          <div class="image">
				          <img src="../../../assets/images/program/class208-musician1.png" alt="musician">
			          </div>
		          </div>
	          </router-link>
          </li>
          <li>
	          ...
	          <router-link to="/experience/program206?classId=167">
		          <div class="card" Style="margin-left: 19px;">
			          ...
			          <div class="image">
				          <img src="../../../assets/images/program/class208-musician2.png" alt="musician">
			          </div>
		          </div>
	          </router-link>
          </li>
