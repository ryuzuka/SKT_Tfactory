<template>
  <div class="contents bottom-sticky" ref="contents">
    ...
    <div class="slider-prd">
      <img src="../../../assets/images/program/class67-slide1.jpg" alt="T Factory X FLO 덕후콘 | 2021.11 김제형">
    </div>
    <!-- //slide -->
    <!-- details -->
    <div class="details sticky">
      ...
      <div class="details-inner">
        ...
        <h3 class="subtit" style="margin-top: 40px;">SOLE, THAMA, Huh!, snzae 소개</h3>
        <div class="thumb"><img src="../../../assets/images/program/class67-conts1.jpg" alt=""></div>
        <p>
          SOLE<br>
          트렌디한 장르의 다양한 곡들을 자유자재로 소화하며 싱어송라이터답게 자신의 이야기를 직접 담는 등 전곡 작사/작곡 능력을 갖추고 있는 SOLE은<br>
          2013년 Mnet&#60;보이스코리아2&#62;를 시작으로 독보적인 음색과 통통 튀는 매력을 선보이며 가요계의 주목을 받고있다.
        </p>
        <p style="margin-top:22px">
          THAMA<br>
          2014년 8월 YG에서 주최하고 62개국 1,000여명이 참가한 빅뱅 태양의 ‘눈, 코, 입’ 커버 콘테스트 &#60;눈, 코, 입(Eyes, Nose, Lips) COVER PROJECT BY YOU&#62;에서 준우승을 차지했다.
        </p>
        <p style="margin-top:22px">
          허성현 (Huh!)<br>
          귀여운 외모 속에 숨겨진 퇴폐미로 ‘작은 거인’이라는 별명을 가지고, 개성 강한 보이스와 독특한 플로우로 ‘힙합 악동’,’힙합 루키’로 떠오르며 씬에서 주목 받고 있다.
        </p>
        <p style="margin-top:22px">
          선재(snzae)<br>
          2017년 Mnet &#60;고등래퍼&#62;에서 귀여운 외모와 공감을 불러일으키는 랩으로 주목받은 아메바컬쳐 신예 선재.
        </p>
        <h3 class="subtit">{{ $t('prd.schedule-place')}}</h3>
        <ul class="texts-list">
          <li>일정 : 12월 5일(일) 오후 6시~8시30분</li>
