	...
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
        ...
        <p class="desc2">
          T Factory와 FLO가 함께 만드는 팬 초청 소규모 콘서트!<br/>
			...
			<div class="line">
				<span style="margin: 0px 51px;">2022. 10. 14 PM 7:00<em style="margin-left: 10px;">MACGUFFIN</em></span>
			...
			<div class="details-header" style="padding: 40px 20px;">
				...
				<div class="thumbnail"><img style="height: 340px;" src="../../../assets/images/program/class227-conts1.jpg" alt=""></div>
				<p class="desc_20" style="margin-top: 8px;">
					맥거핀은 한국의 남성 4인조 락밴드로 2016년 11월 9일 디지털 싱글 “Curtain call”로 데뷔했다.
				</p>
				<p class="desc_20" style="margin-top: 24px;">
					팍(Pock : Pop+Rock)이라는 단어로 맥거핀의 음악 방향성을 보여준다.<br/>
					이는 팝 사운드를 지향하면서 록킹한 연주를 한다는 의미이다.
				</p>
			</div>
			<div class="details-inner">
				...
				<dl>
					<dd>
						...
						<span class="desc">10월 14일 (금) 오후 7시</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px;">신청기간</span>
						<span class="desc">10월 5일 (수) ~ 10월 9일 (일)</span>
					</dd>
					<dd>
						<span class="sub_title" style="width: 65px;">당첨자발표</span>
						<span class="desc">10월 10일 (월) 오후 3시</span>
					</dd>
					<dd>
