<template>
	<div class="contents" :class="{'bottom-sticky': isBookingYn}" ref="contents">
		...
		<div class="slider-prd">
			<img ref="shareImage" src="../../../assets/images/program/class283-slide1.jpg" alt="사진 작가가 직접 알려주는 Photo Class">
		</div>
    <!-- //slide -->
    <!-- details -->
        ...
        <ul>
          <li style="margin-bottom: 32px;">
            ...
            <dl style="margin-bottom: 24px;">
              ...
              <dd>
                ...
                <span class="desc" style="margin-left: 12px;">3/14(화) ~ 3/20(월)</span>
              </dd>
              <dd>
          ...
          <li style="margin-bottom: 32px;">
            ...
            <dl style="margin-bottom: 24px;">
              <dd>
                <span class="sub_title">클래스 일정</span>
                <span class="desc" style="margin-left: 12px;">4/28(금) 오후 7시, 5/12(금) 오후 7시</span>
              </dd>
              <dd>
                <span class="sub_title">응모일정</span>
                <span class="desc" style="margin-left: 12px;">4/14(금) ~ 4/20(목), 4/29(토) ~ 5/5(금)</span>
              </dd>
              <dd>
                <span class="sub_title">당첨자 발표</span>
                <span class="desc" style="margin-left: 12px;">4/21(금), 5/6(토)</span>
              </dd>
            </dl>
            <div class="btn-wrap" style="margin-top: 12px">
