...
var _require = __webpack_require__(/*! ./util */ "./packages/dd-trace/src/util.js"),
    isTrue = _require.isTrue,
    isFalse = _require.isFalse;
...
var Config = function Config(options) {
  ...
  var DD_TRACE_ANALYTICS_ENABLED = coalesce(options.analytics, platform.env('DD_TRACE_ANALYTICS_ENABLED'), platform.env('DD_TRACE_ANALYTICS'), false);
  var DD_PROFILING_ENABLED = coalesce(options.profiling, platform.env('DD_PROFILING_ENABLED'), false);
  var DD_LOGS_INJECTION = coalesce(options.logInjection, platform.env('DD_LOGS_INJECTION'), false);
  var DD_RUNTIME_METRICS_ENABLED = coalesce(options.runtimeMetrics, platform.env('DD_RUNTIME_METRICS_ENABLED'), false);
  var DD_AGENT_HOST = coalesce(options.hostname, platform.env('DD_AGENT_HOST'), platform.env('DD_TRACE_AGENT_HOSTNAME'), '127.0.0.1');
  var DD_TRACE_AGENT_PORT = coalesce(options.port, platform.env('DD_TRACE_AGENT_PORT'), '8126');
  var DD_TRACE_AGENT_URL = coalesce(options.url, platform.env('DD_TRACE_AGENT_URL'), platform.env('DD_TRACE_URL'), null);
  var DD_SERVICE = options.service || platform.env('DD_SERVICE') || platform.env('DD_SERVICE_NAME') || this.tags.service || platform.service() || 'node';
  var DD_ENV = coalesce(options.env, platform.env('DD_ENV'), this.tags.env);
  var DD_VERSION = coalesce(options.version, platform.env('DD_VERSION'), this.tags.version, platform.appVersion());
  var DD_TRACE_STARTUP_LOGS = coalesce(options.startupLogsEnabled, platform.env('DD_TRACE_STARTUP_LOGS'), true);
  var DD_TRACE_ENABLED = coalesce(options.enabled, platform.env('DD_TRACE_ENABLED'), true);
  var DD_TRACE_DEBUG = coalesce(options.debug, platform.env('DD_TRACE_DEBUG'), false);
  var sampler = options.experimental && options.experimental.sampler || {};
  var dogstatsd = coalesce(options.dogstatsd, {});
  ...
  this.scope = isFalse(platform.env('DD_CONTEXT_PROPAGATION')) ? scopes.NOOP : coalesce(options.scope, platform.env('DD_TRACE_SCOPE'));
...
var BrowserExporter = /*#__PURE__*/function () {
...
function cleanEnv(name) {
  return platform.env("DD_TRACE_".concat(name.toUpperCase()).replace(/[^a-z0-9_]/ig, '_'));
}
...
function getConfig(name) {
  ...
  var enabled = cleanEnv("".concat(name, "_ENABLED"));

  if (enabled !== undefined) {
    config.enabled = isTrue(enabled);
  }

  var analyticsEnabled = cleanEnv("".concat(name, "_ANALYTICS_ENABLED"));
  var analyticsSampleRate = Math.min(Math.max(cleanEnv("".concat(name, "_ANALYTICS_SAMPLE_RATE")), 0), 1);
...
var Instrumenter = /*#__PURE__*/function () {
  ...
  _createClass(Instrumenter, [{
    ...
    value: function disable() {
      var _iterator = _createForOfIteratorHelper(this._instrumented.keys()),
          _step;
    ...
    key: "wrapExport",
    value: function wrapExport(moduleExports, wrapper) {
      if (typeof moduleExports !== 'function') return moduleExports;
      var props = Object.keys(moduleExports);
    ...
    key: "unwrapExport",
    value: function unwrapExport(moduleExports) {
...
var log = {
  _isLogLevelEnabled: function _isLogLevelEnabled(level) {
  ...
  reset: function reset() {
    ...
    this._enabled = false;
    this._deprecate = memoize(function (code, message) {
      _this._logger.error(message);
...
var NoopSpan = /*#__PURE__*/function (_Span) {
  _inherits(NoopSpan, _Span);

  var _super = _createSuper(NoopSpan);
  ...
  function NoopSpan(tracer, parent) {
    ...
    _this = _super.call(this); // Avoid circular dependency
...
var NoopSpanContext = /*#__PURE__*/function (_DatadogSpanContext) {
  _inherits(NoopSpanContext, _DatadogSpanContext);

  var _super = _createSuper(NoopSpanContext);
...
var NoopTracer = /*#__PURE__*/function (_Tracer) {
  _inherits(NoopTracer, _Tracer);

  var _super = _createSuper(NoopTracer);
...
var BinaryPropagator = /*#__PURE__*/function () {
...
var HttpPropagator = /*#__PURE__*/function (_TextMapPropagator) {
  _inherits(HttpPropagator, _TextMapPropagator);

  var _super = _createSuper(HttpPropagator);
...
var LogPropagator = /*#__PURE__*/function () {
  function LogPropagator(config) {
...
var TextMapPropagator = /*#__PURE__*/function () {
...
var DatadogSpan = /*#__PURE__*/function (_Span) {
  _inherits(DatadogSpan, _Span);

  var _super = _createSuper(DatadogSpan);
  ...
  function DatadogSpan(tracer, processor, sampler, prioritySampler, fields) {
    ...
    _this._startTime = fields.startTime || _this._getTime();
  ...
  _createClass(DatadogSpan, [{
    ...
    value: function _getTime() {
      var _this$_spanContext$_t = this._spanContext._trace,
          startTime = _this$_spanContext$_t.startTime,
          ticks = _this$_spanContext$_t.ticks;
...
var DatadogSpanContext = /*#__PURE__*/function (_SpanContext) {
  _inherits(DatadogSpanContext, _SpanContext);

  var _super = _createSuper(DatadogSpanContext);
...
var DatadogTracer = /*#__PURE__*/function (_Tracer) {
  _inherits(DatadogTracer, _Tracer);

  var _super = _createSuper(DatadogTracer);
...
/***/ "./packages/dd-trace/src/platform/browser/client.js":
/*!**********************************************************!*\
  !*** ./packages/dd-trace/src/platform/browser/client.js ***!
  \**********************************************************/
/*! no static exports found */
...
var startupLog = __webpack_require__(/*! ./startup-log */ "./packages/dd-trace/src/platform/browser/startup-log.js");
...
var client = __webpack_require__(/*! ./client */ "./packages/dd-trace/src/platform/browser/client.js");
...
/***/ "./packages/dd-trace/src/platform/browser/startup-log.js":
/*!***************************************************************!*\
  !*** ./packages/dd-trace/src/platform/browser/startup-log.js ***!
  \***************************************************************/
/*! no static exports found */
...
module.exports = {
  startupLog: function startupLog() {},
  setStartupLogConfig: function setStartupLogConfig() {},
  setStartupLogInstrumenter: function setStartupLogInstrumenter() {},
...
var setSamplingRules = __webpack_require__(/*! ./platform */ "./packages/dd-trace/src/platform/index.js").startupLog.setSamplingRules;
...
var PrioritySampler = /*#__PURE__*/function () {
...
var setStartupLogInstrumenter = platform.startupLog.setStartupLogInstrumenter;
...
var Tracer = /*#__PURE__*/function (_BaseTracer) {
...
function wrapRemoveListener(removeListener) {
  return function removeListenerWithTrace(eventName, listener) {
    ...
    var _iterator = _createForOfIteratorHelper(listeners.get(listener)),
        _step;
...
var Scope = /*#__PURE__*/function (_Base) {
...
var setStartupLogConfig = platform.startupLog.setStartupLogConfig;
